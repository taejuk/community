...
var studygroupchatrouter = require("./routes/studygroupchat");
var individualchatrouter = require("./routes/individualchat");
var studygrouprouter = require("./routes/studygroup");
mongoose
  ...
  socket.on("message", async function (message) {
    ...
    if (message.recepient == "ALL") {
      ...
      if (message.command == "chat") {
        var room_id =
          cur_user.nickname < message.recepient
            ? cur_user.nickname + message.recepient
            : message.recepient + cur_user.nickname;
        ...
        if (chatData == undefined) {
          var chat = new Chat({
            type: "individual",
            message: { id: cur_user.nickname, text: message.data },
            room_id: room_id,
          });
          await chat.save();
        } else {
